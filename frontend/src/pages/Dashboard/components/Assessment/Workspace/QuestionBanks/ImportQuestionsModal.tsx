  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const questions: PreviewQuestion[] = rows.map((row) => {
        const questionType = String(row["Question Type"] || "MCQ")
          .trim()
          .toUpperCase()
          .replace(/[\s-]+/g, "_");
        ...
        return {
          ...
          options,
          // FIB accepts one or more text answers separated by |.
          // Other question types retain the existing comma-separated format.
            ...
            <div>
              <div className="rounded-2xl border-2 border-dashed p-16 text-center">
                ...
                <p className="mt-2 text-gray-500">
                  Upload a CSV or Excel file containing your questions. For Fill
                  in the Blank, use the Correct Answer column with accepted
                  answers separated by <strong>|</strong>.
                </p>
                  ...
                  <div key={index} className="rounded-xl border p-5">
                    ...
                    {question.question_type === "FILL_IN_THE_BLANK" && (
                      <div className="mt-3 rounded-lg bg-slate-50 p-3 text-sm text-slate-600">
                        ...
                        {question.correct_answers?.join(" · ") || "None"}
                      </div>
                    )}
                  </div>
                ))}
