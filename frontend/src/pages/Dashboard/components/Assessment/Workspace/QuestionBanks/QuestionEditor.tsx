  ...
  const handleValidate = () => {
    ...
    if (
      ...
      if (
        ...
        errors.push(
          "Use between 2 and 4 answer options.",
        );
      }
      ...
      if (
        ...
        errors.push(
          "A selected correct answer is invalid.",
        );
      }
    }
      ...
      const normalizedCorrectAnswers =
        question.correct_answers
          .map((originalIndex) => {
            ...
            return originalToSavedIndex.get(
              originalIndex,
            );
          })
          .filter(
  ...
  const setCorrectAnswer = (
    ...
    setQuestion(
      (current) => {
        ...
        const exists =
          current.correct_answers.includes(
            index,
          );
      ...
      <div className="flex flex-col gap-4 border-b pb-5 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Create an MCQ, Multiple Correct
