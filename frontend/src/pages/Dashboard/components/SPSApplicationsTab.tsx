    ...
    <div>  
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">  
        <input  
          ...
          className="flex-1 px-4 py-3 rounded-xl bg-[#FFFFFF] text-[#1C1B22] border border-[#EBE8E2] outline-none"  
        />

        <select  
          value={genderFilter}  
          onChange={(e) => setGenderFilter(e.target.value)}  
          className="px-4 py-3 rounded-xl bg-[#FFFFFF] text-[#1C1B22] border border-[#EBE8E2]"  
        >  
          ...
          <table className="w-full">  
            ...
            <tbody>  
              {currentApplications.map((app, index) => (  
                <tr  
                  key={app._id}  
                  className="hover:bg-[#FAF9F7] transition"  
                  style={{  
                    borderBottom: "1px solid #EBE8E2",  
                  }}  
                >  
          ...
          >  
            <div className="flex justify-between items-center mb-6">  
              ...
              <button  
                ...
                className="text-[#8A8578] hover:text-[#1C1B22]"  
              >  
                ✕  
              </button>  
            </div>
