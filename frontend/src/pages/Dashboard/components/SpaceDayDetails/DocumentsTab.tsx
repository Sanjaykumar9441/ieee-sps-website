    ...
    <div className="space-y-6">  
      ...
      <div className="rounded-2xl border border-[#EBE8E2] bg-white" style={{ boxShadow: "0 1px 2px rgba(28,27,34,0.04), 0 8px 24px rgba(28,27,34,0.04)" }}>  
        ...
        <div className="divide-y divide-[#EBE8E2]">  
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-6 py-5">  
            <div>  
              <h4 className="font-semibold text-lg text-[#1C1B22]">🖼 Payment Screenshot</h4>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-6 py-5">  
            <div>  
              <h4 className="font-semibold text-lg text-[#1C1B22]">📧 Confirmation Email</h4>
            ...
            <span  
              className={`shrink-0 self-start sm:self-auto rounded-full px-4 py-2 text-sm font-semibold  
        ${  
          registration.paymentStatus === "Verified"  
      ...
      <div className="rounded-2xl border border-[#EBE8E2] bg-white" style={{ boxShadow: "0 1px 2px rgba(28,27,34,0.04), 0 8px 24px rgba(28,27,34,0.04)" }}>  
        <div className="border-b border-[#EBE8E2] px-6 py-5">  
          <h3 className="text-2xl font-bold text-[#1C1B22]">Upcoming Documents</h3>  
        </div>

        <div className="divide-y divide-[#EBE8E2]">  
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-6 py-5">  
            <div>  
              <h4 className="font-semibold text-[#1C1B22]">🎓 Participation Certificate</h4>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-6 py-5">  
            <div>  
              <h4 className="font-semibold text-[#1C1B22]">🏆 Winner Certificate</h4>
