          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="mt-6 text-lg text-slate-600 leading-relaxed max-w-xl">
                ...
                excellence in Signal Processing, Artificial Intelligence,
                Machine Learning, Research, and Technical Innovation through
                impactful events, workshops, and collaborative learning.
              </p>
