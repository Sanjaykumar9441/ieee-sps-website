    ...
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-8">
        <div className="p-5 rounded-xl" style={cardStyle}>
          <h3 className="text-sm font-semibold mb-4 uppercase tracking-wider" style={{ color: "#64748b" }}>
            Registration Status
          </h3>
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-4 mb-5">
        ...
        <div
          ...
          style={{ backgroundColor: "#0f1624", border: "1px solid rgba(99,179,237,0.08)" }}
        >
          ...
          {filteredRegistrations("Pending").map((reg) => (
            <div key={reg._id} className="p-5 rounded-xl" style={cardStyle}>
              <div className="flex items-start justify-between mb-3">
                <h3 className="font-semibold text-base" style={{ color: "#f0f4ff" }}>
                  {reg.teamName}
                </h3>
                <span
              ...
              <div className="mb-4">
                <p className="text-xs font-medium mb-1.5 uppercase tracking-wider" style={{ color: "#64748b" }}>
                  Team Members
                </p>
              ...
              <tbody>
                {filteredRegistrations("Confirmed").map((reg, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-sm font-medium" style={{ color: "#f0f4ff" }}>
                      {reg.teamName}
                    </td>
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              {[
                ...
                <div
                  ...
                  style={{ backgroundColor: "rgba(8,12,20,0.6)", border: "1px solid rgba(99,179,237,0.06)" }}
                >
            ...
            {selectedFullDetails.hostelMembers?.length > 0 && (
              <div className="mb-4">
                <p className="text-xs uppercase tracking-wider mb-2 font-semibold" style={{ color: "#64748b" }}>
                  Hostel Members
                </p>
                <div className="space-y-1.5">
                  {selectedFullDetails.hostelMembers.map((m: any, i: number) => (
                    <div
                      ...
                      style={{ backgroundColor: "rgba(8,12,20,0.6)", color: "#94a3b8" }}
                    >
                      {i + 1}. {m.fullName}
                    </div>
                  ))}
            ...
            <div>
              <p className="text-xs uppercase tracking-wider mb-3 font-semibold" style={{ color: "#64748b" }}>
                Team Members
              </p>
