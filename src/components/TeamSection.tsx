      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
        ...
        >
          ...
          <p className="mt-8 text-lg leading-relaxed dark:text-slate-300 text-slate-600 max-w-2xl">
            Our chapter is driven by passionate innovators,
            technical leaders, researchers, and students
            committed to advancing technology and collaboration.
          </p>
            ...
            >
              ...
              <div className="relative h-full rounded-[30px] border dark:border-white/10 border-black/5 dark:bg-white/5 bg-white/70 backdrop-blur-2xl overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:border-indigo-500/30">
                ...
                <div className="relative z-10 p-8 text-center">
                  ...
                  {/* DESCRIPTION */}
                  <p className="mt-5 text-sm dark:text-slate-400 text-slate-500 leading-relaxed">
                    Passionate about innovation, technical growth,
                    and collaborative engineering excellence.
                  </p>
                  ...
                  <button
                    ...
                    className="mt-8 inline-flex items-center gap-2 text-foreground/80 hover:text-foreground transition-all duration-300 group/button"
                  >
